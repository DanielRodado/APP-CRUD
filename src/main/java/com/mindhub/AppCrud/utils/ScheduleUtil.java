...
public final class ScheduleUtil {
     ...
     * @param startTime The first argument is the start time.
     * @param endTime The second argument is the end time.
     ...
     * @return Returns a boolean; if it meets the time difference (of the last argument) a 'true', otherwise a 'false'.
     * */
    public static boolean checkRangeOfMinutes(LocalTime startTime, LocalTime endTime, int rangeOfDifference) {
        return Math.abs(ChronoUnit.MINUTES.between(startTime, endTime)) < rangeOfDifference;
    }
